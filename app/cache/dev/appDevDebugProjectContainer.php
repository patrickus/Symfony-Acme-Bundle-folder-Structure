...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '192.168.40.199', 'port' => NULL, 'dbname' => 'symfony', 'user' => 'root', 'password' => 'password', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $instance->setHost('192.168.40.199');
        $instance->setPort(25);
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('53f22d649aadc')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_host' => '192.168.40.199',
            'database_port' => NULL,
            'database_name' => 'symfony',
            'database_user' => 'root',
            'database_password' => 'password',
            'mailer_transport' => 'smtp',
            'mailer_host' => '192.168.40.199',
            'mailer_user' => 'user5',
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => '192.168.40.199',
            'swiftmailer.mailer.default.transport.smtp.username' => 'user5',
